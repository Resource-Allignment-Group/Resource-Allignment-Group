...
class User:
    ...
    def fill_user_information(self, db_object):
        ...
        self.checked_out_equipment = (
            db_object["checked_out_equipment"]
            if "checked_out_equipment" in db_object
            else []
        )
        ...
        self.receive_reports = (
            db_object["receive_reports"] if "receive_reports" in db_object else True
        )
        self.profile_image = (
            db_object["profile_image"] if "profile_image" in db_object else None
        )
